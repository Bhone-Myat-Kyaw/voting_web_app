...
function adminMiddleware(req, res, next) {
  const accessToken = req.cookies.access_token; // Fixed: req.cookies, not req.cookie
  const refreshToken = req.cookies.refresh_token; // Fixed: req.cookies, not req.cookie
