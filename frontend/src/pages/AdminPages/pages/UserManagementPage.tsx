...
function UserManagementPage() {
  ...
  const { data: students, isError, error } = useQuery({
    queryKey: ["students"],
    queryFn: async () => {
      const res = await axios.get(`${import.meta.env.VITE_SERVER}/api/admin/selectAll`, {
  ...
  const roleMutation = useMutation({
    mutationFn: ({ admissionid, role }: { admissionid: string; role: string }) => axios.post(`${import.meta.env.VITE_SERVER}/api/admin/changeRole`, { admissionid, role }, { withCredentials: true }),
