        ...
        <form action="#" className="space-y-5 w-[95%] m-auto" onSubmit={submitFunction}>
          ...
          <div className="flex flex-col items-start justify-center gap-2">
            ...
            <input 
              ...
              className={`border rounded-3xl p-3 placeholder:text-cmedium-gray w-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent ${
